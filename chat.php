...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="col-xs-10 col-sm-11 col-md-11 col-lg-11" style="background:transparent;padding: 10px;margin-top:50px;">
            <input type="text" id="chatsearch" placeholder="Search Conversation" class="form-control" style="padding: 5px" >
        </div>

        <div class="col-xs-2 col-sm-1 col-md-1 col-lg-1" style="background:transparent;padding: 10px;margin-top:50px;">
