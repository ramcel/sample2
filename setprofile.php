                    ...
                    <div role="tabpanel" class="tab-pane active" id="profile">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <button style="float:right;" class="btn btn-primary addoccupationtoggle"><span class="glyphicon glyphicon-plus"></span></button>

                                <h4 style='color:#337AB7;'><span class="glyphicon glyphicon-lock"></span> Occupation</h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <button style="float:right;" class="btn btn-primary addsubjecttoggle"><span class="glyphicon glyphicon-plus"></span></button>

                                <h4 style='color:#337AB7;'><span class="glyphicon glyphicon-book"></span> Subject</h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <button style="float:right;" class="btn btn-primary addawardstoggle"><span class="glyphicon glyphicon-plus"></span></button>

                                <h4 style='color:#337AB7;'><span class="glyphicon glyphicon-certificate"></span> Achivements / Awards</h4>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              <button style="float:right;" class="btn btn-primary adddegreettoggle"><span class="glyphicon glyphicon-plus"></span></button>

                              <h4 style='color:#337AB7;'><span class="glyphicon glyphicon-education blue"></span> Degree</h4>
                            </div>
